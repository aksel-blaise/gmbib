...
# keyword map
map1 = thematicMap(df, field = "DE", n = 200, minfreq = 2, stemming = FALSE, size = 0.8, n.labels = 1, repel = TRUE)
# plot map
plot(map1$map)
```
...
# network plot
educollabnet1 = networkPlot(educollab1, n = 50, Title = "Edu Collaboration", type = "fruchterman", size = 25, size.cex = T, edgesize = 3, labelsize = 0.3)
